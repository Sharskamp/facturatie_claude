...
contextBridge.exposeInMainWorld('api', {
  ...
  facturen: {
    ...
    scanPdf: (filePath: string) => ipcRenderer.invoke('facturen:scanPdf', filePath),
    scanPdfLokaal: (filePath: string) => ipcRenderer.invoke('facturen:scanPdfLokaal', filePath),
    startHistorischeImport: (filePaths: string[]) => ipcRenderer.invoke('facturen:startHistorischeImport', filePaths),
    historischeImportStatus: (jobId: string) => ipcRenderer.invoke('facturen:historischeImportStatus', jobId),
    retryHistorischeImportItem: (jobId: string, itemId: string) => ipcRenderer.invoke('facturen:retryHistorischeImportItem', jobId, itemId),
  ...
  uitgaven: {
    ...
    previewBon: (data: unknown) => ipcRenderer.invoke('uitgaven:previewBon', data),
  ...
  agenda: {
    ...
    verwijderAfspraak: (eventId: string, calendarId?: string) => ipcRenderer.invoke('agenda:verwijder-afspraak', eventId, calendarId),
  },
  producten: {
