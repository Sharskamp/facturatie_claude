...
INSERT INTO "new_Factuur" ("aangemaakt", "agendaAfspraakId", "betalingsCondities", "bijgewerkt", "btwBedrag", "btwVerlegd", "datum", "handmatigBetaald", "herinneringVerzondenOp", "id", "klantId", "kortingBedrag", "kortingPercentage", "notities", "nummer", "offerteId", "status", "subtotaal", "terugkerend", "terugkerendInterval", "totaal", "vervaldatum", "verzondenOp") SELECT "aangemaakt", "agendaAfspraakId", "betalingsCondities", "bijgewerkt", "btwBedrag", "btwVerlegd", "datum", "handmatigBetaald", "herinneringVerzondenOp", "id", "klantId", "kortingBedrag", "kortingPercentage", "notities", "nummer", "offerteId", "status", "subtotaal", "terugkerend", "terugkerendInterval", "totaal", "vervaldatum", "verzondenOp" FROM "Factuur";
DROP TABLE "Factuur";
...
CREATE TABLE "new_FactuurRegel" (
    ...
    "isReiskosten" BOOLEAN NOT NULL DEFAULT false,
    "reiskostenBegindatum" DATETIME,
    "reiskostenEinddatum" DATETIME,
    CONSTRAINT "FactuurRegel_factuurId_fkey" FOREIGN KEY ("factuurId") REFERENCES "Factuur" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_FactuurRegel" ("aantal", "btwPercentage", "eenheid", "factuurId", "id", "kortingPercentage", "omschrijving", "prijs", "totaal", "volgorde") SELECT "aantal", "btwPercentage", "eenheid", "factuurId", "id", "kortingPercentage", "omschrijving", "prijs", "totaal", "volgorde" FROM "FactuurRegel";
...
CREATE TABLE "new_Klant" (
    ...
    "taal" TEXT NOT NULL DEFAULT 'nl',
    "afspraakHerinneringActief" BOOLEAN,
    "afspraakHerinneringModus" TEXT,
    "afspraakHerinneringVoorafUren" INTEGER,
    "afspraakHerinneringDagen" INTEGER,
    "afspraakHerinneringTijd" TEXT,
    "aangemaakt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "bijgewerkt" DATETIME NOT NULL
);
INSERT INTO "new_Klant" ("aangemaakt", "actief", "adres", "afspraakHerinneringActief", "afspraakHerinneringDagen", "afspraakHerinneringModus", "afspraakHerinneringTijd", "afspraakHerinneringVoorafUren", "bedrijf", "bijgewerkt", "btwNummer", "email", "iban", "id", "kvkNummer", "land", "naam", "notities", "postcode", "stad", "telefoon") SELECT "aangemaakt", "actief", "adres", "afspraakHerinneringActief", "afspraakHerinneringDagen", "afspraakHerinneringModus", "afspraakHerinneringTijd", "afspraakHerinneringVoorafUren", "bedrijf", "bijgewerkt", "btwNummer", "email", "iban", "id", "kvkNummer", "land", "naam", "notities", "postcode", "stad", "telefoon" FROM "Klant";
DROP TABLE "Klant";
...
CREATE TABLE "new_User" (
    ...
    "emailFactuurOnderwerp" TEXT,
    "emailHerinneringOnderwerp" TEXT,
    "emailHerinneringTekst" TEXT,
    "agendaHerinneringActief" BOOLEAN NOT NULL DEFAULT false,
    "agendaHerinneringModus" TEXT NOT NULL DEFAULT 'vooraf',
    "agendaHerinneringVoorafUren" INTEGER NOT NULL DEFAULT 2,
    "agendaHerinneringDagen" INTEGER NOT NULL DEFAULT 1,
    "agendaHerinneringTijd" TEXT NOT NULL DEFAULT '09:00',
    "emailBcc" TEXT,
    "emailBevestigingOnderwerp" TEXT,
    "emailBevestigingTekst" TEXT,
    "emailFactuurTekst" TEXT,
    "logoBase64" TEXT,
...
INSERT INTO "new_User" ("aangemaakt", "adres", "agendaHerinneringActief", "agendaHerinneringDagen", "agendaHerinneringModus", "agendaHerinneringTijd", "agendaHerinneringVoorafUren", "bedrijfsnaam", "betalingsherinneringen", "bijgewerkt", "btwNummer", "email", "emailBcc", "emailBevestigingOnderwerp", "emailBevestigingTekst", "emailFactuurOnderwerp", "emailFactuurTekst", "emailHerinneringOnderwerp", "emailHerinneringTekst", "emailSmtpHost", "emailSmtpPass", "emailSmtpPort", "emailSmtpSecure", "emailSmtpUser", "factuurPrefix", "factuurVolgNummer", "googleAccessToken", "googleRefreshToken", "googleTokenExpiry", "herinneringDagen", "iban", "id", "korActief", "korDrempel", "kvkNummer", "logo", "naam", "offertePrefix", "offerteVolgNummer", "postcode", "stad", "standaardBetaalTermijn", "standaardBtwTarief", "telefoon", "wachtwoord", "website") SELECT "aangemaakt", "adres", "agendaHerinneringActief", "agendaHerinneringDagen", "agendaHerinneringModus", "agendaHerinneringTijd", "agendaHerinneringVoorafUren", "bedrijfsnaam", "betalingsherinneringen", "bijgewerkt", "btwNummer", "email", "emailBcc", "emailBevestigingOnderwerp", "emailBevestigingTekst", "emailFactuurOnderwerp", "emailFactuurTekst", "emailHerinneringOnderwerp", "emailHerinneringTekst", "emailSmtpHost", "emailSmtpPass", "emailSmtpPort", "emailSmtpSecure", "emailSmtpUser", "factuurPrefix", "factuurVolgNummer", "googleAccessToken", "googleRefreshToken", "googleTokenExpiry", "herinneringDagen", "iban", "id", "korActief", "korDrempel", "kvkNummer", "logo", "naam", "offertePrefix", "offerteVolgNummer", "postcode", "stad", "standaardBetaalTermijn", "standaardBtwTarief", "telefoon", "wachtwoord", "website" FROM "User";
DROP TABLE "User";
